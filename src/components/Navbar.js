...
function Navbar() {
  return (
    <div className="navbar">
      {/* navbaer first top section four icons */}
      <div className="navbar__top-icons">
        {/* <!-- navbar Home icon --> */}
        <div className="navbar__top-icon">
          <svg
            viewBox="0 0 24 24"
      ...
      {/* <!-- navbar top four icons finished --> */}

      {/* <!-- horizintal line between sections --> */}
      <div className="navbar__horizintal-line"></div>

      {/* <!-- navbar second section under top four icons --> */}
      <div className="navbar__second-navigation-icons">
        {/* <!-- navbar Library icon --> */}
        <div className="navbar__top-icon">
          <svg
            viewBox="0 0 24 24"
        ...
        {/* <!-- navbar The Freelancer's Jo... icon --> */}
        <div className="navbar__top-icon">
          <svg
            viewBox="0 0 24 24"
            preserveAspectRatio="xMidYMid meet"
          ...
          <span>The Freelancer's Jo...</span>
        </div>
      </div>
      <div className="navbar__horizintal-line"></div>

      {/* <!-- navbar third section, subscription section --> */}
      <div className="navbar__subscriptions">
        ...
        <div className="navbar__subscriptions--div">
          <img
            src="https://yt3.googleusercontent.com/ytc/AMLnZu8oxQGSHceb8RQNZ03a2jIDAmC1Z4MRp4G83S1KMZA=s88-c-k-c0x00ffffff-no-rj"
            alt="Zakir Naik"
            className="navbar__subscriptions--div--img"
          />
          <p className="navbar__subscriptions--div--chanel-name">
        ...
        <div className="navbar__subscriptions--div">
          <img
            src="https://yt3.googleusercontent.com/ytc/AMLnZu_GS4vuibuZjr4ZBgVr97RrriUQrrhqeyWQWqMYfQ=s88-c-k-c0x00ffffff-no-rj"
        ...
        <div className="navbar__subscriptions--div">
          <img
            src="https://yt3.googleusercontent.com/ytc/AMLnZu_fS27UeSqFj38sQbPX82RmAjwzs3QxzxpqVhBz=s88-c-k-c0x00ffffff-no-rj"
            alt="Islam Sobhi"
            className="navbar__subscriptions--div--img"
          />
          <p className="navbar__subscriptions--div--chanel-name">Islam Sobhi</p>
        </div>
        <div className="navbar__subscriptions--div">
          <svg
            viewBox="0 0 24 24"
          ...
          <p className="navbar__subscriptions--div--chanel-name">Show 7 more</p>
        </div>
      </div>
      ...
      {/* <!-- navbar forth section, explore section --> */}
      <div className="navbar__explore">
        <h2 className="navber__explore--h2">Explore</h2>
        {/* <!-- Trending icon --> */}
        <div className="navbar__explore--div">
          <svg
            viewBox="0 0 24 24"
            preserveAspectRatio="xMidYMid meet"
            focusable="false"
      ...
      {/* <!-- navbar fifth section, more From YouTube section --> */}
      <div className="navbar__more-youtube">
        <h2 className="navber__more-youtube--h2">More from YouTube</h2>

        {/* <!-- navbar Creator Studio icon --> */}
        <div className="navbar__more-youtube--div">
          <svg
            viewBox="0 0 24 24"
            preserveAspectRatio="xMidYMid meet"
            focusable="false"
      ...
      {/* <!-- navbar sixth section, Settings section --> */}
      ...
      {/* <!-- navbar seventh section, Terms and conditions section --> */}
      <div className="navbar__terms-text">
        <p>
