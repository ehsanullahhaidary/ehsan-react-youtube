...
import "./header.css";
import userImage from "../images/ehsan.png";

function Header() {
  return (
    <header className="header ">
      <div className="header__icons">
        {/* the two menu and youtube logo at left side of header */}
        <div className="header__left-icons">
          <div className="header__icons--background">
            {/* menu icon */}
            <svg
              viewBox="0 0 24 24"
              preserveAspectRatio="xMidYMid meet"
              focusable="false"
              className="header__icons--size-round style-scope yt-icon"
          ...
          <svg
            ...
            preserveAspectRatio="xMidYMid meet"
            focusable="false"
            className="header__icons--youtube-icon style-scope yt-icon"
            style={{ display: "block", width: "100%", height: "100%" }}
          >
            <g
              viewBox="0 0 90 20"
        ...
        {/* a div for spacing in middle of icons */}
        <div className="header__space-div"></div>
        {/* search input and search icon in middle of header */}
        <div className="header__middle-icons">
          {/* search input */}
          <input
            type="text"
            placeholder="Search"
            className="header__middle-icons--input"
          />
          {/* vertical line in middle of search input and search icon */}
          <div className="header__middle-icons--vertical-line"></div>
          <div className="tooltip header__middle-icons--search header__icons--background">
            {/* middle section search icon */}
            <svg
              viewBox="0 0 24 24"
              preserveAspectRatio="xMidYMid meet"
              focusable="false"
              className="tooltip header__icons--size-round style-scope yt-icon"
              style={{ display: "block", width: "100%", height: "100%" }}
            >
              <g className="style-scope yt-icon">
                <path
        ...
        <div className="tooltip header__second-middle-icons--mic-icon header__icons--background">
          {/* middle section mic icon */}
          <svg
            viewBox="0 0 24 24"
            preserveAspectRatio="xMidYMid meet"
            focusable="false"
        ...
        {/* search, mic, bill icons and user logo at right side of header */}
        <div className="header__right-icons">
          <div className="tooltip header__right-icons--search header__icons--background">
          ...
          <div className="tooltip header__right-icons--mic header__icons--background">
          ...
          <div className="tooltip header__right-icons--video-call header__icons--background">
            {/* right section Create-video icon */}
            <svg
              viewBox="0 0 24 24"
              preserveAspectRatio="xMidYMid meet"
              focusable="false"
          ...
          <div className="tooltip header__right-icons--notifications header__icons--background">
            ...
            <div className="header__icons--notifications">9+</div>
            <span className="tooltiptext">Notifications</span>
          </div>
          <img src={userImage} alt="user" className="header__icons--image" />
        </div>
      </div>
    </header>
  );
